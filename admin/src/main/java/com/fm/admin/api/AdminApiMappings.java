...
public interface AdminApiMappings extends AdminApiKeys
{
   ...
   public static final String LEAGUE_SEASON_PAGE = "/admin/league/${" + SELECTED_LEAGUE_SID_KEY + "}/season";

   public static final String TEAM_DETAILS_PAGE = "/admin/team/${" + SELECTED_TEAM_SID_KEY + "}/details";
